  ...
  Widget build(BuildContext context) {
    ...
    final privacy_body_text = RichText(
      ...
      TextSpan(
          style: paragraph,
          text:
              "Ledi is A menstrual management application that is available for android systems. The app helps you track your period days and your symptoms "
      ...
      TextSpan(
          style: paragraph,
          text:
              "I am grateful to Nehemie Niyomahoro for the wonderful design and to all those who provided useful feedback.\n\n"),
      TextSpan(
      ...
      TextSpan(
          style: paragraph,
          text:
              "Please support me so that I can continue maintaining this application. If you want to donate, just contact me via email.\n\n"),
      TextSpan(
        text: "App version\n\n",
        style: sub_heading_style,
      ),
      TextSpan(style: paragraph, text: "1.0.0+1\n\n"),
    ]));
